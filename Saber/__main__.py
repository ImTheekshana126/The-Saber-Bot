...
from Saber import (ALLOW_EXCL, CERT_PATH, DONATION_LINK, LOGGER,
...
SABER_IMG = "https://telegra.ph/file/46e6d9dfcb3eb9eae95d9.jpg"
...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module("Saber.modules." +
                                              module_name)
